...
<body>
    <header class="front_template_header">
		...
		<div class="navigation_menu_principal">
			...
			<a href="index.php?action=blog" target="blank"><h2>Blog</h2></a>
			<a href="index.php?action=contact"><h2>Contact</h2></a>
		</div>
    </header>

	<div class="errorPage">
        <p class="errorPageMsg">Oups! Cette page n'existe pas. Merci de revenir à l'accueil.</p>
		<a class="goBackAccueil" href="index.php?action=home">Accueil</a>
    </div>
