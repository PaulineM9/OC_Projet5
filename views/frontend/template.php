...
<head>
	...
	<link rel="icon" type="image/png" href="../public/favicon_super!.jpeg" /><!-- favicon -->

	<!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Major+Mono+Display|Pacifico&display=swap" rel="stylesheet"> 
	...
	<!-- FB Open Graph data -->
	<meta property="og:title" content="SUPER! Création de sites web" />
	...
	<meta name="description" content="SUPER! Création de sites web" />
